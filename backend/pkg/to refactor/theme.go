...
//	_, err := DatabaseClient.Exec(sqlQuery)
//	return err
//}
//
//// GetByID returns data about
//func (t *Theme) GetByID(id string) error {
//	err := DatabaseClient.QueryRow(fmt.Sprintf("SELECT * FROM themes WHERE id = '%s' ;", id)).Scan(
//		&t.Path,
//		&t.ReleaseDate,
//		&t.CreatorName,
//		&t.Description,
...
//	err := DatabaseClient.QueryRow(fmt.Sprintf("SELECT * FROM themes WHERE id = '%v' ;", limit)).Scan(
//		&t.Path,
//		&t.ReleaseDate,
//		&t.CreatorName,
//		&t.Description,
...
//	var id int
//	_ = DatabaseClient.QueryRow(fmt.Sprintf("SELECT max(id) FROM themes;")).Scan(&id)
//	return id
//}
//
...
//	var themes []Theme
//
//	rows, err := DatabaseClient.Query(fmt.Sprintf("SELECT * FROM themes WHERE creator_name = '%s' LIMIT 4;", creator))
//	if err != nil {
...
//	var themes []Theme
//
//	rows, err := DatabaseClient.Query("SELECT * FROM themes ORDER BY release_date LIMIT 4;")
//	if err != nil {
//		fmt.Println(err.Error())
//	}
//	for rows.Next() {
